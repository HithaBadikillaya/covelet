        ...
        <View style={styles.container}>
            <View style={styles.storyCard}>
                <View style={styles.badgeRow}>
                    <View style={styles.badgePill}>
                        <Text style={styles.badgeText}>SCRAPBOOK APP FOR CLOSE CIRCLES</Text>
                    </View>
                ...
                <Text style={styles.subtitle}>
                    Covelet turns group memories into something you can revisit, play with, and grow over time instead of letting them disappear into old chats.
                </Text>
            ...
            <View style={styles.collageRow}>
                <View style={[styles.collageCard, styles.mainCard]}>
                    ...
                    <Text style={styles.cardTitle}>Wall posts, board notes, constellation memories, flashbacks, and time capsules.</Text>
                    <Text style={styles.cardBody}>Everything feels like one living scrapbook instead of a bunch of disconnected features.</Text>
                </View>
                ...
                <View style={styles.sideStack}>
                    ...
                    <View style={[styles.collageCard, styles.sideCardBottom]}>
                        ...
                        <Text style={styles.statLabel}>your people, your pace, your stories</Text>
                    </View>
                </View>
            </View>
        </View>
