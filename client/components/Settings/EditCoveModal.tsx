...
import { SECURITY_LIMITS, normalizeMultilineText, normalizeSingleLineText } from '@/utils/security';
...
export const EditCoveModal: React.FC<EditCoveModalProps> = ({
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!safeName) {
                setError('Please provide a valid name for your cove.');
                setLoading(false);
                return;
            }
            ...
            logger.error('Error updating cove:', err);
